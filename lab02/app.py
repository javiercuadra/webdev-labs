...
current_user = CurrentUser(
    first_name='Javi', last_name='Cuadra', email='erub03@gmail.com', username='erub03')
...
@app.route('/')
def exercise1():
    return "Howdy, " + current_user.first_name + "! Mighty fine day today, dontcha agree?"
...
def exercise4():
    ...
    return render_template(
        ...
        location=location,
        # just show the first restaurant in the list.
